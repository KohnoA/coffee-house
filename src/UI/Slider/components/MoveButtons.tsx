...
function MoveButtons({ changeSlideHandler, activeSlideIndex }: MoveButtonsProps) {
  ...
  return (
    <>
      <Button
        className="group absolute top-1/2 -translate-y-[50%] left-1 !py-[18px] !px-[18px] max-sm:invisible"
      ...
      <Button
        className="group absolute top-1/2 -translate-y-[50%] right-1 !py-[18px] !px-[18px] max-sm:invisible"
