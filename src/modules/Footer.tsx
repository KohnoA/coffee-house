...
export default function Footer() {
  return (
    <footer id={MAIN_SECTIONS_ID.CONTACT_US} className="container mb-[40px]">
      <div className="flex items-center gap-[100px] py-[100px] px-[100px] text-textLight bg-bgContainer rounded-[40px] max-xl:flex-col max-xl:px-[60px] max-xl:items-start max-sm:px-[16px] max-sm:py-[60px] max-sm:gap-[40px]">
        <div className='max-sm:w-full max-sm:text-center'>
          ...
          <SocialList className='max-sm:justify-center' />
        </div>
